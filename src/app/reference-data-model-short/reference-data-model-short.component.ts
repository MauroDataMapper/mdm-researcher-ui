...
@Component({
  selector: 'mdm-reference-data-model-short',
  templateUrl: './reference-data-model-short.component.html',
  styleUrls: ['./reference-data-model-short.component.scss']
})
export class ReferenceDataModelShortComponent implements OnInit {
